...
<body>
  <div class="main">
    <form class="form" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
      ...
      <p class="desc">Join Phuoc Long High School Basketball Club 🏀</p>
      ...
      <div class="form-group">
        ...
        <select class="form-control" id="birthday-day" name="day">
        ...
        <select class="form-control" id="birthday-year" name="year">
          <option value="0">
            Year
          </option>
